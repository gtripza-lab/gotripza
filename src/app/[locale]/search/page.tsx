...
export default async function SearchPage({
  ...
  return (
    ...
    <div className="chat-viewport-lock fixed inset-0 flex h-[var(--gtz-visual-height,100dvh)] min-h-[var(--gtz-visual-height,100svh)] max-h-[var(--gtz-visual-height,100dvh)] w-[100dvw] max-w-[100dvw] flex-col bg-[#06111e]">
